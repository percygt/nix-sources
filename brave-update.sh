...
find_release_with_asset() {
  ...
  echo "brave-update.sh: no release with asset matching '${template}' found within ${MAX_PAGES} pages of ${PAGE_SIZE}" >&2
  return 1
}
...
write_package_nix() {
  ...
  {
    echo '# Expression generated by brave-update.sh; do not edit it by hand!'
